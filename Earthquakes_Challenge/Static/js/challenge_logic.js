...
L.geoJson(data, {
  ...
  // sets style of the circle
  style: styleInfo,

  //circleMarker displays magnitude and location of earthquakes
  onEachFeature: function(feature, layer) {
      layer.bindPopup("Magnitude: " + feature.properties.mag + "<br>Location: " + feature.properties.place);
    }
...
// Looping through our intervals to generate a label with a colored square for each interval.
  ...
  L.geoJson(plateData, {
      // Style lines with color and weight to stand out
      color: "#ff6500",
      weight: 3
    })
    // Add the tectonic layer group var created in Step 1 above
    .addTo(tectonicPlates);
  });
    // add the tectonic layer group var to the map
